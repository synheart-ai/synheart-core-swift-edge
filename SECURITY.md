...
1. **GitHub Security Advisory (preferred).**
   [Open a private advisory](https://github.com/synheart-ai/synheart-core-swift-edge/security/advisories/new).
...
This policy covers the `SynheartCoreEdge` SDK published from this repository. Issues
